using Dapr.Client;
using FirstACAAppWebAPI.Models;

namespace FirstACAAppWebAPI.Services
{
    public class TasksStoreManager : ITasksManager
    {
        ...
        // Task<List<TaskModel>> ITasksManager.GetTasksByCreator(string createdBy)
        // {
        //     throw new NotImplementedException();
        // }

        // Task<TaskModel?> ITasksManager.GetTaskById(Guid taskId)
        // {
        //     throw new NotImplementedException();
        // }
    }
